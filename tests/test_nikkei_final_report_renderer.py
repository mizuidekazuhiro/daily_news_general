...
def test_renderer_shows_all_articles_and_hides_ref_markers():
    ...
    all_articles = [
        ...
        {"title": "t2", "url": "https://nikkei.example/2", "notion_url": "https://notion.so/2", "importance_score": 2, "issue_date": "2026-05-06", "edition": "evening", "source": "Nikkei", "matched_rules": ["Japan", "Steel"]},
    ]
...
def test_load_notion_map(tmp_path):
