"""Last-line duplicate mail protection for morning news jobs.

Only known morning-news subjects are guarded. The actual Gmail Sent lookup is
shared with scripts/check_mail_delivery_guard.py and fails open on IMAP errors.
"""
...
from scripts.check_mail_delivery_guard import already_sent
